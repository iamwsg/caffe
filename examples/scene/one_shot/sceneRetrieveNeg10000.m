...
qImagFeatFile=['/media/sf_Datasets/Scenes/posFeats/',qImageCells{nQcell-1},'_',qImageCells{nQcell},'.mat']

feat=load(qImagFeatFile);
pos_feat1=feat.pos_feat1;
...
testImags=dir('/media/sf_Datasets/Scenes/posFeats/');

%% preload negtive features
disp('preload negative features')
load('/media/sf_Datasets/Scenes/negFeats10000.mat');
neg=negFeats10000;
...
for ii=1:nTest
    ...
    image_path2=strcat('/media/sf_Datasets/Scenes/images/',testScene,'/',testImage);
    ...
    tImagFeatFile=['/media/sf_Datasets/Scenes/posFeats/',tImageCells{nTcell-1},'_',tImageCells{nTcell},'.mat']
