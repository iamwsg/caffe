...
for jj=591:600
    ...
    tRes=cell(nTest, 9); %14:naive thresholding label; 15:two-step label; 16: first step mark
...
%% do the test
    ...
    fileName=strcat('imageRetreveAngle205W/imageRetreve_',cpath{6},'_',cpath{7},'.mat');
