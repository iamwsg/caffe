...
qImagFeatFile=['/media/sf_Datasets/Scenes/posFeatsHOG/',qImageCells{nQcell-1},'_',qImageCells{nQcell},'.mat']
...
testImags=dir('/media/sf_Datasets/Scenes/posFeatsHOG/');

%% preload negtive features
disp('preload negative features')
load('/media/sf_Datasets/Scenes/negHOG.mat');
neg=negHOG;
...
for ii=551:nTest
    ...
    tImagFeatFile=['/media/sf_Datasets/Scenes/posFeatsHOG/',tImageCells{nTcell-1},'_',tImageCells{nTcell},'.mat']
